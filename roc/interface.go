...
//
// Each slot of a peer (see Slot) has multiple interfaces, one for each of the
// interface types. The user interconnects peers by binding an interface of one
// peer to an URI, and then connecting the corresponding interface of another
// peer to that URI.
//
...
//
// InterfaceAudioControl is a lower-level bidirectional interface for control
// streams. If you use InterfaceAudioSource and InterfaceAudioRepair, you
