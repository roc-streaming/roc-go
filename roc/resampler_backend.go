...
const (
	// Default backend.
	//
	// Selects ResamplerBackendBuiltin when using ClockSyncProfileResponsive, or
	...
	//
	// Recommended for ClockSyncProfileResponsive and on good CPUs.
	...
	//
	// Recommended for ClockSyncProfileGradual and on cheap CPUs.
